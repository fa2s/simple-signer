(() => {
  ...
  var LineRenderer = class extends Base {
    ...
    mount(root) {
      ...
      ul_info.append(name);
      this.signer.documents.forEach(({ name: name2, value }) => {
  ...
  var AutoRenderer = class {
    ...
    mount(root) {
      ...
      const renderer = new Factory(this.#signer, this.#contents);
  ...
  var Signer = class {
    ...
    mount(container) {
      ...
      const renderer = new renderers_default[this.format](this.signer, this.#backend.contents);
      renderer.text = this.text;
      renderer.checked = this.checked;
